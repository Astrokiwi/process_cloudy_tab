...
def process_table_tau(taumode,nodustmode,highdensemode,tableFile,taumax=5.):
    global loadedFile,d_in
    
    if tableFile==loadedFile:
...
if __name__ == '__main__':
    ...
    process_table_tau(taumode,nodustmode,highdensemode,"highden_260118.txt")
